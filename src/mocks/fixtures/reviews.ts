...
export const mockReviews: Review[] = [
  ...
  {
    id: "headshot-hub-scrim-block",
    cafeName: "Headshot Hub",
    gameTitle: "Counter-Strike 2",
    authorName: "Simran Kaur",
    authorInitials: "SK",
    rating: 5,
    category: "staff",
    title: "Best scrim room we have booked",
    comment:
      "Dedicated fibre held up across three straight scrims, and the analyst desk let us review rounds between maps.",
    visitedAt: "2026-04-15",
    helpfulCount: 48,
    tags: ["Scrim room", "Coaching desk", "Counter-Strike 2"],
  },
  {
    id: "frame-rate-club-rooftop",
    cafeName: "Frame Rate Club",
    gameTitle: "Valorant",
    authorName: "Rohan Iyer",
    authorInitials: "RI",
    rating: 4.7,
    category: "crowd",
    title: "Rooftop queues run late and stay fun",
    comment:
      "Ranked queues filled fast even after midnight, and the rooftop break area made long sessions much easier.",
    visitedAt: "2026-04-03",
    helpfulCount: 29,
    tags: ["Late night", "Valorant", "Tournament nights"],
  },
  {
    id: "loot-drop-tabletop",
    cafeName: "Loot Drop Cafe",
    gameTitle: "Baldur's Gate 3",
    authorName: "Tanvi Desai",
    authorInitials: "TD",
    rating: 4.2,
    category: "food",
    title: "Great coffee, slower on busy evenings",
    comment:
      "The espresso and quiet corners are excellent for long campaigns, though orders slow down once the weekend crowd arrives.",
    visitedAt: "2026-03-21",
    helpfulCount: 9,
    tags: ["Coffee", "Board games", "Private rooms"],
  },
  {
    id: "side-quest-student-rates",
    cafeName: "Side Quest Station",
    gameTitle: "Mario Kart",
    authorName: "Aditya Nair",
    authorInitials: "AN",
    rating: 4.1,
    category: "setup",
    title: "Best value for a casual evening",
    comment:
      "Rates are genuinely student friendly and the handheld corner is a nice touch, but the couches could use an upgrade.",
    visitedAt: "2026-03-09",
    helpfulCount: 7,
    tags: ["Budget", "Mario Kart", "Console pods"],
  },
];
